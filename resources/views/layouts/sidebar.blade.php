    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        @if(Auth::user()->role->role === 'Super Admin')
          ...
          @if(Auth::user()->role->role === 'Admin' && Auth::user()->role_access === 'on' || Auth::user()->role->role === 'Author' && Auth::user()->role_access === 'on' || Auth::user()->role->role === 'Super Admin')
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon far fa-user"></i>
              <p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('role.all')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Roles</p>
                </a>
              </li>
          ...
          @if(Auth::user()->role->role === 'Admin' && Auth::user()->account_access === 'on' || Auth::user()->role->role === 'Author' && Auth::user()->account_access === 'on' || Auth::user()->role->role === 'Super Admin')
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon far fa-user"></i>
              <p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('logout.request')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Logout</p>
                </a>
              </li>
          ...
          <!-- <li class="nav-header" style="margin-top:220%;">LABELS</li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon far fa-circle text-danger"></i>
              <p class="text">Important</p>
